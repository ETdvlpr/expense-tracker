...
class CustomLinearProgressIndicator extends StatefulWidget {
  ...
  ///padding to the CustomLinearProgressIndicator
  ...
  /// position to display the positioned indicator
...
class _CustomLinearProgressIndicatorState
  ...
  void _checkIfNeedCancelAnimation(CustomLinearProgressIndicator oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final percentPositionedHorizontal = widget.indicatorPosition != null
        ? _containerWidth * widget.indicatorPosition! - _indicatorWidth / 3
